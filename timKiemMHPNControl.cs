...
{
    public partial class timKiemMHPNControl : UserControl
    {
        public timKiemMHPNControl()
        {
            InitializeComponent();
            ...
            lbGiaNhap.MouseHover += Control_MouseHover;
        ...
        // Truyền thông tin từ mặt hàng vào 
        public void thongTin(MatHang mh)
        {
            ...
            lbGiaNhap.Text = Convert.ToString(mh.fDonGia);
        }
        ...
        public void SubscribeToButtonClickEvent(EventHandler handler)
        {
            ...
            lbGiaNhap.Click += handler;
        }
        private void timKiemMHPNControl_Load(object sender, EventArgs e)
        {
        }
    }
}
